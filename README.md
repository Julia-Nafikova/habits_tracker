...
Отправка напоминаний о выполнении привычек реализована при помощи интеграции с мессенджером [Telegram](https://web.telegram.org/)
...
```
git clone git@github.com:Julia-Nafikova/habits_tracker.git
cd habits_tracker
```
